...
@Component({
  selector: 'app-listamisfotosfeas',
  templateUrl: './listamisfotosfeas.page.html',
  styleUrls: ['./listamisfotosfeas.page.scss'],
})
export class ListamisfotosfeasPage implements OnInit {
